<template>
  <div class="digit-captcha-page">
    <el-card class="digit-captcha-card">
      <template #header>
        <div class="card-header">
          <span>{{ t('features.digitCaptcha.title') }}</span>
          <small>
            <a
              :href="'https://github.com/pomelo-admin/vue-pomelo-admin/blob/main/src/components/features/digit-captcha/index.vue'"
              target="_blank"
              rel="noopener noreferrer"
              style="color: #409eff; text-decoration: none"
            >
              {{
                t('features.digitCaptcha.componentPath', {
                  path: 'src/components/features/digit-captcha/index.vue',
                })
              }}
            </a>
          </small>
      ...
      <p class="component-description">{{ t('features.digitCaptcha.description') }}</p>
...
import { ElCard, ElDivider, ElEmpty } from 'element-plus';
